...
function startNewQuiz() {
    // Nettoyage de l'état de correction si besoin
...
function submitQuiz() {
    ...
    currentQuestions.forEach((data, index) => {
        ...
        if (correctLabel) {
            ...
            correctLabel.classList.remove('selected'); // S'assure que le vert écrase le bleu si correct
        }
        ...
        if (selectedAnswer && selectedAnswer !== data.correct) {
            ...
            // S'assure que l'option sélectionnée et correcte est bien en VERT
            correctLabel.classList.add('correct-answer');
